...
class SettingsService {
	constructor() {
		this.defaultSettings = {
			...
			product_fields:
				'path,id,name,category_id,category_name,sku,images,enabled,discontinued,stock_status,stock_quantity,price,on_sale,regular_price,attributes,tags,position,algorithm',
			products_limit: 30,
			weight_unit: 'kg',
			length_unit: 'cm',
